...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "q", function () awful.spawn("rofi-logout") end, --awesome.quit,
...
--awful.spawn.once("variety")
--awful.spawn.once("xfce4-power-manager")
--awful.spawn.once("redshift")
--awful.spawn.once("pamac-tray")
--awful.spawn.once("xfce4-volumed-pulse")
