...
local function set_wallpaper(s)
    if beautiful.wallpaper then
        ...
        awful.spawn.with_shell("nitrogen --restore"..beautiful.wallpaper)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    -- Exit screen
    awful.key({ modkey, "Shift" }, "x", function() awful.spawn("rofi-logout") end, --exit_screen_show() end,
              {description = "show exit screen", group = "awesome"}),
    awful.key({ modkey,           }, "Escape", function () awful.spawn("rofi-logout") end,-- exit_screen_show() end,
              {description = "show exit screen", group = "awesome"}),
...
client.connect_signal("request::titlebars", function(c)
    ...
    --------------   Titlebar items   ----------------
--    awful.titlebar(c, { size = beautiful.titlebar }) : setup {
    awful.titlebar(c, { size = dpi(28), fg_focus = "#000000" }) : setup {
        { -- Left
...
--awful.spawn.with_shell("/home/tomas/.config/awesome/autostart.sh")
